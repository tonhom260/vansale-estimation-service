...
const customList = [
    { value: "all", label: "ทั้งหมด", background: "", color: "" },
    { value: 'OVERDUE', label: 'ดำเนินการล่าช้า', color: "#C2410C", background: "#FFF7ED" },
    { value: 'INPROCESS', label: 'กำลังดำเนินการ', color: "#2563EB", background: "#EFF6FF" },
    { value: 'COMPLETE', label: 'อนุมัติและเสร็จสิ้น', color: "#16A34A", background: "#F0FDF4" },
    { value: 'REJECT', label: 'ไม่อนุมัติและเสร็จสิ้น', color: "#DC2626", background: "#FEF2F2" },
];
...
export default function AutoCompleteMultipleUseformTag({ placeholder = "", disabled = false, name, formData, label = "", size = "small", required = false, options = customList }: Props) {
    const {
        control,
        watch,
        setValue,
                                    ...
                                    >
                                        <div
                                            ...
                                            <input
                                                ...
                                                style={{ marginRight: 8 }}
                                            />
                                            <span className='ml-2 px-3 py-2 rounded-xl' style={{
                                                color: option?.color,
