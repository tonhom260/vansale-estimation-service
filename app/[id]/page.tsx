...
export default function EstimationInput() {
  ...
  async function getReport() {
    ...
    if (result && result?.CustomerOrderEstimation.length > 0) {
      ...
      const itemsList = result.CustomerOrderEstimation.map(e => ({ ...e, index: fields.findIndex(i => i.product_code1 == e.productcode) }))
        ...
        <div className="w-full h-full p-4 px-5 flex">
          <div className="h-full">
            ...
            <div className="flex  mt-2">
              ...
              <div className="h-[30px] ml-1 mr-2 pt-1  text-[12px] text-black ">{currentUnit}</div>
            </div>
          </div>
